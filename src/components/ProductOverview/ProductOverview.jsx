  ...
  return (
    <section className='text-black mt-20 xl:flex xl:w-full xl:justify-between xl:mx-auto xl:h-[70vh] xl:mt-48'>
      ...
      <div className='flex flex-col w-full px-6 py-20 2xl:px-32 mx-auto gap-6 lg:w-[60%] xl:w-[40%] '>
        ...
        <AnimatedButton text={"Discover Post-Poo Drops"} isWidthFull={"true"} className={"hover:text-white xl:w-[80%] hover:bg-secondary border-gray-300  text-black"} />
      </div>
